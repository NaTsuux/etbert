...
def training_opts(parser):
    ...
    parser.add_argument("--seq_length", type=int,
                        default=128, help="Sequence length.")
...
def finetune_opts(parser):
    ...
    parser.add_argument(
        ...
        default="models/pre-trained_model.bin",
        type=str,
    ...
    parser.add_argument(
        "--vocab_path", default="models/encryptd_vocab.txt", type=str, help="Path of the vocabulary file."
    )
    parser.add_argument(
        "--spm_model_path",
        default=None,
    ...
    parser.add_argument(
        "--data_path", type=str, required=True, help="Path of the dataset."
    )
    parser.add_argument(
        "--config_path",
...
def infer_opts(parser):
    ...
    parser.add_argument(
        "--vocab_path",
        default="models/encryptd_vocab.txt",
        type=str,
    ...
    parser.add_argument(
        "--prediction_path", type=str, help="Path of the prediction file."
    )
    parser.add_argument(
        "--config_path",
        default="models/bert/base_config.json",
